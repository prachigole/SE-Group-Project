...
var index=1,index_lunch=1000,index_snacks=2000,index_dinner=3000;
function getBreakfastData1(){
    var pos=0;
    console.log("adsf");
    var d = document.getElementById("date-head");
    ...
    case 12:
      ...
      var final_d = `${day} ${month_str} ${year}, ${day_str}`;
      console.log(final_d);
      d.innerHTML = `${final_d}`;
    ...
    for(const i in foodData)
    {
        ...
        cell5.innerHTML = `<div class='quantity' style='display: flex; float: right; width: 70%; justify-content: space-between;'>
                            <button onClick='decrementQty(this.id);' id=${index_lunch++} class='decrement-btn' style='cursor: pointer; font-size: 20px; color:#F46036; float: right; width:25px; border-radius: 5px; background-color: transparent; border-color:#F46036 ;'>&#8722;</button>
                            <input type='text' style='text-align:center;border: none; border-color: transparent;' maxlength='2' size='1'max='10' value='0' width='10px' >
                            <button onClick='incrementQty(this.id);' id=${index_lunch++} class='increment-btn' style='cursor: pointer; font-size: 20px; color:#F46036; float: right; width:25px; border-radius: 5px; background-color: transparent; border-color:#F46036 ;'>&#43;</button></div>`
    ...
    for(const i in foodData)
    {
        ...
        cell5.innerHTML = `<div class='quantity' style='display: flex; float: right; width: 70%; justify-content: space-between;'>
                            <button onClick='decrementQty(this.id);' id=${index_snacks++} class='decrement-btn' style='cursor: pointer; font-size: 20px; color:#F46036; float: right; width:25px; border-radius: 5px; background-color: transparent; border-color:#F46036 ;'>&#8722;</button>
                            <input type='text' style='text-align:center;border: none; border-color: transparent;' maxlength='2' size='1'max='10' value='0' width='10px' >
                            <button onClick='incrementQty(this.id);' id=${index_snacks++} class='increment-btn' style='cursor: pointer; font-size: 20px; color:#F46036; float: right; width:25px; border-radius: 5px; background-color: transparent; border-color:#F46036 ;'>&#43;</button></div>`
    ...
    for(const i in foodData)
    {
        ...
        cell5.innerHTML = `<div class='quantity' style='display: flex; float: right; width: 70%; justify-content: space-between;'>
                            <button onClick='decrementQty(this.id);' id=${index_dinner++} class='decrement-btn' style='cursor: pointer; font-size: 20px; color:#F46036; float: right; width:25px; border-radius: 5px; background-color: transparent; border-color:#F46036 ;'>&#8722;</button>
                            <input type='text' style='text-align:center;border: none; border-color: transparent;' maxlength='2' size='1'max='10' value='0' width='10px' >
                            <button onClick='incrementQty(this.id);' id=${index_dinner++} class='increment-btn' style='cursor: pointer; font-size: 20px; color:#F46036; float: right; width:25px; border-radius: 5px; background-color: transparent; border-color:#F46036 ;'>&#43;</button></div>`
...
function viewSelectedBreakfastItems()
{
    ...
    for(var i in select_breakfast_food)
    {
        ...
        cell1.innerHTML = `${select_breakfast_food[i].foodname}`;
        cell2.innerHTML = `${select_breakfast_food[i].cal}`;
        cell3.innerHTML = `${select_breakfast_food[i].count}`;
    ...
    document.getElementById("popup").children[0].innerHTML="Break fast data subitted";  
...
{
    var select_food_index=0;
    var select_lunch_food = [];
    for(var i=1001; i<index_lunch; i=i+2)
    {
        var val = document.getElementById(i).previousElementSibling.value;
        if(val>0)
        {
    ...
    document.getElementById("lunch-food").style.display = "none";
    document.getElementById("btn-submit-lunch").disabled = true;
    document.getElementById("ln").disabled = true;
    for(var i in select_lunch_food)
    {
        // document.getElementById("food").style.display="none";
        document.getElementById("selectFood-lunch").style.display="block";
        var pos=0;
        var t = document.getElementById("selected-lunch");
        var row = t.insertRow(pos);
        var cell1 = row.insertCell(0);
        var cell2 = row.insertCell(1);
        var cell3 = row.insertCell(2);
        ...
        cell1.innerHTML = `${select_lunch_food[i].foodname}`;
        cell2.innerHTML = `${select_lunch_food[i].cal}`;
        cell3.innerHTML = `${select_lunch_food[i].count}`;
    ...
    document.getElementById("bk").disabled = true;
    document.getElementById("okbtn").addEventListener("click",removepopup);
    document.getElementById("popup").children[0].innerHTML="Your lunch data is submitted successfully";  
    document.getElementById("popup").style.display="block"; 
    function removepopup()
        {
          document.getElementById("popup").style.display="none";
...
function viewSelectedSnacksItems()
{
    select_snacks_food = [];
    var select_food_index=0;
    for(var i=2001; i<index_snacks; i=i+2)
    {
    ...
    for(var i in select_snacks_food)
    {
        ...
        document.getElementById("snacks-food").style.display = "none";
        document.getElementById("btn-submit-snacks").disabled = true;
        document.getElementById("snks").disabled = true;
    for(var i in select_snacks_food)
    {
        // document.getElementById("food").style.display="none";
        document.getElementById("selectFood-snacks").style.display="block";
        var pos=0;
        var t = document.getElementById("selected-snacks");
        var row = t.insertRow(pos);
        var cell1 = row.insertCell(0);
        var cell2 = row.insertCell(1);
        var cell3 = row.insertCell(2);
        ...
        cell1.innerHTML = `${select_snacks_food[i].foodname}`;
        cell2.innerHTML = `${select_snacks_food[i].cal}`;
        cell3.innerHTML = `${select_snacks_food[i].count}`;
    ...
    document.getElementById("bk").disabled = true;
    document.getElementById("okbtn").addEventListener("click",removepopup);
    document.getElementById("popup").children[0].innerHTML="Your snacks data is submitted successfully";  
    document.getElementById("popup").style.display="block"; 
    function removepopup()
        {
          document.getElementById("popup").style.display="none";
...
function viewSelectedDinnerItems()
{
    var select_food_index=0;
    select_dinner_food = [];
    for(var i=3001; i<index_dinner; i=i+2)
    {
    ...
    document.getElementById("dinner-food").style.display = "none";
    document.getElementById("btn-submit-dinner").disabled = true;
    document.getElementById("dnr").disabled = true;
    for(var i in select_dinner_food)
    {
        // document.getElementById("food").style.display="none";
        document.getElementById("selectFood-dinner").style.display="block";
        var pos=0;
        var t = document.getElementById("selected-dinner");
        var row = t.insertRow(pos);
        var cell1 = row.insertCell(0);
        var cell2 = row.insertCell(1);
        var cell3 = row.insertCell(2);
        ...
        cell1.innerHTML = `${select_dinner_food[i].foodname}`;
        cell2.innerHTML = `${select_dinner_food[i].cal}`;
        cell3.innerHTML = `${select_dinner_food[i].count}`;
    ...
    document.getElementById("bk").disabled = true;
    document.getElementById("okbtn").addEventListener("click",removepopup);
    document.getElementById("popup").children[0].innerHTML="Your dinner data is submitted successfully";  
    document.getElementById("popup").style.display="block"; 
    function removepopup()
        {
          document.getElementById("popup").style.display="none";
