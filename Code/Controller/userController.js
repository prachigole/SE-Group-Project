...
exports.addRequestFood = (req,res,next) =>{
      res.render('addFoodRequest')
}

exports.addRequestFoodPost = async (req,res,next) =>{
      ...
      for(let i = 0; i < foods.length; i++)
      {
            Feedback.create({
                  food_name: foods[i],
                  userUserId:req.session.user.user_id 
            }).catch(err => console.log("Error On adding request Food: " + err))
      }
